...
KCMUtils.SimpleKCM {
    ...
    // VerticalClock: AM/PM row toggle
    property alias cfg_showAmPmRow: showAmPmRowCheckBox.checked
    ...
    Kirigami.FormLayout {
        ...
        // VerticalClock: show AM/PM row toggle (only relevant in 12-hour mode on vertical panels)
        QQC2.CheckBox {
            id: showAmPmRowCheckBox
            Kirigami.FormData.label: i18n("Vertical panel:")
            text: i18n("Show AM/PM indicator row")
            enabled: cfg_use24hFormat !== 2
        }
