...
MouseArea {
    ...
    states: [
        ...
        State {
            ...
            AnchorChanges {
                ...
                // VerticalClock: anchor below the stacked layout, not the hidden labelsGrid
                anchors.top: verticalClockStack.bottom
                anchors.horizontalCenter: verticalClockStack.horizontalCenter
            }
        },
    ...
    */
    Item {
        ...
        // VerticalClock: stacked hour / minute / AM-PM layout for vertical panels
        ColumnLayout {
            id: verticalClockStack
            ...
            // true when the resolved time format includes AM/PM
            readonly property bool is12h: main.timeFormat.indexOf("AP") !== -1
